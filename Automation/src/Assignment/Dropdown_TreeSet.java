...
public class Dropdown_TreeSet {
	...
	public static void main(String[] args) {
		...
		driver.get("file:///C:/Users/sanket/Desktop/RegistrationPage.html");
		
		// identify the particular drop-down
		WebElement dropdown = driver.findElement(By.xpath("//select[@value='duplicate']"));
		...
		//Treeset does not accept the duplicate value
